...
<center>
    ...
    <form action="post3.php" method="POST" enctype="multipart/form-data" >
        <input type="text" id="companyName" placeholder="Company Name" class="company_name" name="comp_name" require>
