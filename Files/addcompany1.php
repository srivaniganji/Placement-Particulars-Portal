...
<body class="body">
    ...
    <center>
        <h1 class="company">Company Management</h1><br>

        <!-- Form to add a new company -->
        <form action="post4.php" method="POST" enctype="multipart/form-data">

            <select id="companyDropdown" name="comp_name" class="company_name" required>
                <?php
...
$conn = new mysqli($db_host, $db_user, $db_pass, $db_name);
            ...
            Job Desc:<input type="file" name="jobfile" id="file">
            Quesions:<input type="file" name="file" id="file">
            <br><br>
            <label for="years">Select a year:</label>
            <select id="years" name="selected_year">
...
Function to delete a company function deleteCompany(index) {
