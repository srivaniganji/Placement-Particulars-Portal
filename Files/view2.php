    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="navbar-text" href="view2.php">PLACED STUDENTS</a>
                </li>
                <li class="nav-item">
    ...
    <table id="example" class="table example">
        ...
        include "db_conn.php";
                ...
                if($result->num_rows > 0)
                {
                    ...
                    {
                        echo "<tr><td>".$row["id"]."</td><td>".$row["sid"]."</td><td>".$row["name"]."</td><td>".
                        $row["dept"]."</td><td>".$row["year"]."</td><td>".$row["company"]."</td><td>".
                        $row["ctc"];?>
        <?php //$_SESSION['mainid']=$row["sid"]?>
        <?php $searchid=$row["sid"]?>
        <td><a href="profile.php?<?php echo 'id';?>=<?php echo $row['id'];?>" style="color:blue;">ViewMore</a></td>
