...
<body>
        ...
        include "db_conn.php";
                ...
                if($result->num_rows > 0)
                {
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        $row["ctc"]."</td>";
                        echo '<td><a href="adminprofile.php?id='.$row["id"].'" style="color:blue;">ViewMore</a></td>';
                        echo "</tr>";
                    } 
                        echo "</table>";
                }
    ...
    <script>
     ...
     <center><button style="width:10rem; height:3rem; border-radius:0.2rem; margin-right:2rem; border-width: 0.25rem; background-color: rgb(19, 185, 19); border-style: none"><a href="studentadmin.php" class="mahi">Add Students</a></button></center>
</body>
