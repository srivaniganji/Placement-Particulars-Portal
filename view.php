    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="navbar-text" href="downloadpdf1.php">COMPANIES</a>
                </li>
                <li class="nav-item">
                ...
                if($result->num_rows > 0)
                {
                   $s=0;
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        $row["ctc"]."</td>";
                        echo '<td><a href="profile.php?id='.$row["id"].'" style="color:blue;">ViewMore</a></td>';
                        echo "</tr>";
                    } 
                        echo "</table>";
                }
...
.cursor {
    width: 50px;
    height: 50px;
    border: 3px solid rgba(22, 211, 63, 0.822);
    border-radius: 100%;
    position: absolute;
...
.cursor::after {
    ...
    height: 20px;
    position: absolute;
    border: 20px solid rgb(64, 13, 80);
    border-radius: 50%;
    opacity: .5;
    top: 0px;
    left: 0px;
